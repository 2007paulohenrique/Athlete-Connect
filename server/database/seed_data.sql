...
INSERT INTO esporte (nome, descricao) VALUES
('Futebol', 'Esporte coletivo mais popular do mundo, onde duas equipes de 11 jogadores disputam para marcar gols no campo adversário.'),
('Basquete', 'Modalidade coletiva onde duas equipes de cinco jogadores competem para arremessar uma bola em um aro elevado.'),
('Tênis', 'Esporte individual ou em duplas, onde os jogadores usam raquetes para rebater a bola para o lado adversário.'),
('Xadrez', 'Jogo individual de estratégia e lógica, onde dois jogadores competem para dar xeque-mate no rei do adversário.'),
('Judô', 'Arte marcial olímpica que utiliza técnicas de projeção e imobilização para vencer o adversário.'),
('Boxe', 'Esporte de combate em que os participantes usam luvas para realizar golpes diretos em um ringue.'),
('Escalada', 'Esporte de aventura onde o praticante escala superfícies rochosas ou paredes artificiais.'),
('Parapente', 'Atividade aérea que consiste em voar utilizando um paraquedas controlável, geralmente em locais montanhosos.'),
('Surf', 'Esporte aquático praticado no mar, onde atletas utilizam pranchas para deslizar sobre ondas.'),
('Canoagem', 'Modalidade aquática que utiliza canoas ou caiaques para percorrer rios, lagos ou mares.'),
('Esqui', 'Esporte de inverno praticado em neve, que envolve deslizar sobre superfícies usando esquis.'),
('Snowboard', 'Modalidade de inverno onde o atleta desliza sobre a neve em uma prancha, realizando manobras.'),
('Tiro com Arco', 'Esporte de precisão onde os participantes utilizam arcos para lançar flechas em alvos.'),
('Golfe', 'Modalidade de precisão onde jogadores utilizam tacos para acertar bolas em buracos ao longo de um campo.'),
('Hipismo', 'Esporte equestre que inclui salto, adestramento e provas de resistência, destacando a interação entre cavalo e cavaleiro.'),
('Rodeio', 'Modalidade que envolve montaria em touros e cavalos, com provas de habilidade e força.'),
('Basquete em Cadeira de Rodas', 'Versão adaptada do basquete para pessoas com deficiência física.'),
('Natação Paralímpica', 'Modalidade de natação adaptada para atletas com diferentes tipos de deficiência.'),
('E-Sports', 'Competição de videogames em ambiente virtual, abrangendo modalidades como MOBA, FPS e battle royale.'),
('Paintball', 'Jogo recreativo onde os participantes utilizam marcadores para disparar tinta em adversários.'),
('Triatlo', 'Competição que combina natação, ciclismo e corrida, testando a resistência e versatilidade dos atletas em diferentes modalidades.'),
('Ciclismo de Estrada', 'Modalidade onde ciclistas percorrem longas distâncias em estradas pavimentadas, combinando resistência e estratégia.'),
('BMX', 'Variante do ciclismo com foco em manobras acrobáticas e competições em pistas com obstáculos.'),
('Handebol', 'Esporte coletivo jogado com as mãos, onde equipes buscam marcar gols no gol adversário.'),
('Polo Aquático', 'Modalidade aquática onde os jogadores utilizam uma bola para marcar gols em piscinas.'),
('Damas', 'Jogo de tabuleiro onde os participantes utilizam estratégias para capturar as peças do oponente.'),
('Corrida de Rua', 'Modalidade de atletismo realizada em vias urbanas, com distâncias variando de 5 km a maratonas.'),
('Corrida de Revezamento', 'Modalidade em que equipes de atletas se alternam para completar um percurso dividido em etapas.'),
('Fórmula 1', 'Categoria de automobilismo de alta performance, realizada em circuitos fechados.'),
('Rali', 'Competição de automobilismo realizada em terrenos variados, como terra, areia e asfalto.'),
('Arremesso de Peso', 'Prova onde o atleta lança uma esfera metálica o mais longe possível, combinando força e técnica.'),
('Salto com Vara', 'Modalidade de atletismo onde os competidores utilizam uma vara para alcançar a maior altura possível.'),
('Vôlei', 'Esporte coletivo jogado entre duas equipes, onde o objetivo é enviar a bola por cima da rede e evitar que ela toque no chão do lado adversário.'),
('Parkour', 'Atividade que consiste em se deslocar de forma ágil e eficiente em ambientes urbanos ou naturais, superando obstáculos com saltos, escaladas e manobras.'),
('Powerlifting', 'Modalidade de levantamento de peso que consiste em três provas: agachamento, supino e levantamento terra, com foco em força máxima.'),
('Strongman', 'Competição que envolve a realização de várias provas de força, incluindo levantamento de pesos, transporte de objetos pesados e superação de obstáculos.'),
('Fisiculturismo', 'Esporte que enfatiza o desenvolvimento muscular e a estética corporal, com competições que avaliam a simetria, proporção, definição e o volume muscular dos atletas.'),
('Paraquedismo', 'Atividade aérea que envolve saltar de um avião e planar com um paraquedas, proporcionando uma experiência de queda livre e vistas aéreas.');
